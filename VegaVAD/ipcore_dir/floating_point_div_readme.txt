The following files were generated for 'floating_point_div' in directory
D:\Library_Projects_FPGA\VegaVAD\ipcore_dir\

Generate XCO file:
   CORE Generator input file containing the parameters used to generate a core.

   * floating_point_div.xco

C Simulation Generator:
   Please see the core data sheet.

   * floating_point_div/cmodel/floating_point_v6_1_bitacc_cmodel_lin.zip
   * floating_point_div/cmodel/floating_point_v6_1_bitacc_cmodel_lin64.zip
   * floating_point_div/cmodel/floating_point_v6_1_bitacc_cmodel_nt.zip
   * floating_point_div/cmodel/floating_point_v6_1_bitacc_cmodel_nt64.zip

Generate EJava outputs:
   Please see the core data sheet.

   * demo_tb/tb_floating_point_div.vhd

Generate Implementation Netlist:
   Binary Xilinx implementation netlist files containing the information
   required to implement the module in a Xilinx (R) FPGA.

   * floating_point_div.ngc
...
Deliver IP Symbol:
   ...
   * floating_point_div.asy

SYM file generator:
   Generate a SYM file for compatibility with legacy flows

   * floating_point_div.sym
...
Generate ISE project file:
   ...
   * floating_point_div.gise
   * floating_point_div.xise

Deliver Readme:
   Readme file for the IP.

   * floating_point_div_readme.txt

Generate FLIST file:
   Text file listing all of the output files produced when a customized core was
   generated in the CORE Generator.

   * floating_point_div_flist.txt
